...
final class VoltaicJeiRecipeUtil {
    ...
    static <T extends Recipe<?>> List<T> getAllRecipesFor(RecipeManager manager, RecipeType<T> type) {
        // 0) Best-effort: find *any* 1-arg method that accepts RecipeType and returns recipes.
        // Mojang occasionally renames helpers across patch versions.
        ...
        // 1) Try modern helper if present (name differs across 26.1.x patches)
        ...
        // 2) Fallback: introspect internal recipe maps
