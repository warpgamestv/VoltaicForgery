...
public class AssemblyStationBlock extends BaseEntityBlock {
    ...
    public static final MapCodec<AssemblyStationBlock> CODEC = MapCodec.unit(AssemblyStationBlock::new);

    public AssemblyStationBlock() {
        super(BlockBehaviour.Properties.of()
                .setId(ResourceKey.create(Registries.BLOCK, VoltaicContent.id("assembly_station")))
                .strength(3.0F)
                .noOcclusion());
    }
    ...
    protected MenuProvider getMenuProvider(BlockState state, Level level, BlockPos pos) {
        ...
        return blockEntity instanceof AssemblyStationBlockEntity assemblyStation ? assemblyStation : null;
    }
}
